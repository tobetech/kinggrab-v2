...
export default function Sidebar({
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: 'ตาม Location',
      icon: FiMapPin,
      description: 'แสดงข้อมูลตาม Location ที่เลือก',
    },
  ]
  ...
  const hasActiveFilters = telNoFilter || actionFilter || mNameFilter || locationFilter
                ...
                <div className="p-3 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-lg border-2 border-yellow-300">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`px-2 py-1 rounded text-xs font-medium ${
                      ...
                      {adminData?.status === 'admin' ? 'admin' : 'user'}
                    </span>
                  </div>
                </div>
              </div>
